"""Extension of cifar10_gamma_retune_head.py: gamma=0.2/0.3 kept climbing with no sign
of instability, so extend the grid to find where it peaks or destabilizes before locking
in a final headline gamma for the T=300 combo result.
"""
import sys
import os
import json
...
def main():
    ...
    print("\nGamma retune extension done.", flush=True)
